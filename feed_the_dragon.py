...
GAME_FOLDER = 'D:/projects pyhton/feed_the_dragon/'
WINDOW_WIDTH = 1400
WINDOW_HEIGHT = 700
...
background_image = pygame.transform.scale( pygame.image.load(GAME_FOLDER + 'coffee.jpg'), (WINDOW_WIDTH, WINDOW_HEIGHT))

#Game Actors
dragon = pygame.transform.scale(pygame.image.load(GAME_FOLDER + 'worker.png'),(70,70))
...
title = big_game_font.render('FEED THE CHEF', True, GREEN)
